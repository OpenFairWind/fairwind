 ...
 */
public class TheoreticalWindChillTemperatureView extends TemperatureView {
    public TheoreticalWindChillTemperatureView(Context context) {
        super(context);
        initializeViews(context,null,0);
    }

    public TheoreticalWindChillTemperatureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initializeViews(context,attrs,0);
    }

    public TheoreticalWindChillTemperatureView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initializeViews(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs!=null) {
            ...
            //TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TheoreticalWindChillTemperatureView);


            String path = FairWindModelBase.getEnvOutsideTheoreticalWindChillTemperaturePath(vessel_uuid);
            String label="T. WIND CHILL TEMP.";
