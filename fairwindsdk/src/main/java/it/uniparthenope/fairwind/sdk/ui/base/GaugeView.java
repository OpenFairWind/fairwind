...
public class GaugeView extends View {
    private static final String LOG_TAG = "GAUGE_VIEW";
    ...
    public static final int NEEDLE_COLOR = Color.WHITE;
    ...
    public static final int SCALE_SUBDIVISIONS_COLOR =-3;
    public static final float TEXT_NUMBER_SIZE = 0.09f;

    public static final int[] OUTER_SHADOW_COLORS = {Color.argb(255, 255, 254, 187), Color.argb(255, 255, 247, 219),
    ...
    //        Color.rgb(0, 0, 0)};
    public static final float[] RANGE_VALUES =  {-780f, -90f, -30f, 0f, 30f, 90f, 780f};
    ...
    public static final int TEXT_SHADOW_COLOR = Color.argb(255, 0, 0, 0);
    public static final int TEXT_VALUE_COLOR = Color.WHITE;
    public static final int TEXT_NUMBER_COLOR = -3;
    ...
    public boolean getShowOuterShadow() { return mShowOuterShadow; }
    public void setShowOuterShadow(boolean value) { mShowOuterShadow=value; init();}

    private boolean mShowOuterBorder;
    public boolean getShowOuterBorder() { return mShowOuterBorder; }
    public void setShowOuterBorder(boolean value) { mShowOuterBorder=value; init();}

    private boolean mShowOuterRim;
    public boolean getShowOuterRim() { return mShowOuterRim; }
    public void setShowOuterRim(boolean value) { mShowOuterRim=value; init(); }

    private boolean mShowInnerRim;
    public boolean getShowInnerRim() { return mShowInnerRim; }
    public void setShowInnerRim(boolean value) { mShowInnerRim=value; init(); }

    private boolean mShowScale;
    public boolean getShowScale() { return mShowScale; }
    public void setShowScale(boolean value) { mShowScale=value; init();}

    private boolean mShowRanges;
    public boolean getShowRanges() { return mShowRanges; }
    public void setShowRanges(boolean value) { mShowRanges=value; init();}

    private boolean mShowNeedle;
    public boolean getShowNeedle() { return mShowNeedle; }
    public void setShowNeedle(boolean value) { mShowNeedle=value; init(); }

    private boolean mShowText;
    public boolean getShowText() { return mShowText; }
    public void setShowText(boolean value) { mShowText=value; init(); }

    private float mOuterShadowWidth;
    public float getOuterShadowWidth() { return mOuterShadowWidth; }
    public void setOuterShadowWidth(float value) { mOuterShadowWidth=value; }

    private float mOuterBorderWidth;
    public float getOuterBorderWidth() { return mOuterBorderWidth; }
    public void setOuterBorderWidth(float value) { mOuterBorderWidth=value; }

    private float mOuterRimWidth;
    public float getOuterRimWidth() { return mOuterRimWidth; }
    public void setOuterRimWidth(float value) { mOuterRimWidth=value; }

    private float mInnerRimWidth;
    public float getInnerRimWidth() { return mInnerRimWidth; }
    public void setInnerRimWidth(float value) { mInnerRimWidth=value; }

    private float mInnerRimBorderWidth;
    public float getInnerRimBorderWidth() { return mInnerRimBorderWidth; }
    public void setInnerRimBorderWidth(float value) { mInnerRimBorderWidth=value; }

    private float mNeedleWidth;
    public float getNeedleWidth() { return mNeedleWidth; }
    public void setNeedleWidth(float value) { mNeedleWidth=value; }

    private float mNeedleHeight;
    public float getNeedleHeight() { return mNeedleHeight; }
    public void setNeedleHeight(float value) { mNeedleHeight=value; }

    private int mNeedleColor;
    public int getNeedleColor() { return mNeedleColor; }
    public void setNeedleColor(int value) { mNeedleColor=value; }

    private int mInnerCircleColor;
    public int getInnerCircleColor() { return mInnerCircleColor; }
    public void setInnerCircleColor(int value) { mInnerCircleColor=value; }

    private int mOuterCircleColor;
    public int getOuterCircleColor() { return mOuterCircleColor; }
    public void setOuterCircleColor(int value) { mOuterCircleColor=value; }

    private float mScalePosition;
    public float getScalePosition() { return mScalePosition; }
    public void setScalePosition(float value) { mScalePosition=value; }

    private float mScaleStartValue;
    public float getScaleStartValue() { return mScaleStartValue; }
    public void setScaleStartValue(float value) { mScaleStartValue=value; }

    private float mScaleEndValue;
    public float getScaleEndValue() { return mScaleEndValue; }
    public void setScaleEndValue(float value) { mScaleEndValue=value; }

    private float mScaleStartAngle;
    public float getScaleStartAngle() { return mScaleStartAngle; }
    public void setScaleStartAngle(float value) { mScaleStartAngle=value; }

    private float[] mRangeValues;
    public float[] getRangeValues() { return mRangeValues; }
    public void setRangeValues(float[] value) { mRangeValues=value; }

    private int[] mRangeColors;
    public int[] getRangeColors() { return mRangeColors; }
    public void setRangeColors(int[] value) { mRangeColors=value; }

    private int mDivisions;
    public int getDivisions() { return mDivisions; }
    public void setDivisions(int value) { mDivisions=value; }

    private int mSubdivisions;
    public int getSubdivisions() { return mSubdivisions; }
    public void setSubdivisions(int value) { mSubdivisions=value; }

    private int mSubDivisionsColor;
    public int getSubDivisionsColor() { return mSubDivisionsColor; }
    public void setSubDivisionsColor(int value) { mSubDivisionsColor=value; }

    private float mTextNumberSize;
    public float getTextNumberSize() { return mTextNumberSize; }
    public void setTextNumberSize(float value) { mTextNumberSize=value; }
    ...
    public void setTextValue(String value) { mTextValue=value; }

    private String mTextUnit;
    public String getTextUnit() { return mTextUnit; }
    public void setTextUnit(String value) { mTextUnit=value; }

    private int mTextValueColor;
    public int getTextValueColor() { return mTextValueColor; }
    public void setTextValueColor(int value) { mTextValueColor=value; }

    private int mTextNumberColor;
    public int getTextNumberColor() { return mTextNumberColor; }
    public void setTextNumberColor(int value) { mTextNumberColor=value; }

    private int mTextUnitColor;
    public int getTextUnitColor() { return mTextUnitColor; }
    public void setTextUnitColor(int value) { mTextUnitColor=value; }

    private int mTextShadowColor;
    public int getTextShadowColor() { return mTextShadowColor; }
    public void setTextShadowColor(int value) { mTextShadowColor=value; }

    private float mTextValueSize;
    public float getTextValueSize() { return mTextValueSize; }
    public void setTextValueSize(float value) { mTextValueSize=value; }

    private float mTextUnitSize;
    public float getTextUnitSize() { return mTextUnitSize; }
    public void setTextUnitSize(float value) { mTextUnitSize=value; }
    ...
    private void readAttrs(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        Log.d(LOG_TAG,":"+R.styleable.GaugeView_showTexts);
        Log.d(LOG_TAG,"mShowText:"+mShowText);
        ...
        mSubDivisionsColor=a.getInteger(R.styleable.GaugeView_subdivisionsColor, SCALE_SUBDIVISIONS_COLOR);
        mTextNumberColor = a.getColor(R.styleable.GaugeView_textNumberColor, TEXT_NUMBER_COLOR);
        mTextNumberSize=a.getFloat(R.styleable.GaugeView_textNumberSize, TEXT_NUMBER_SIZE);
    ...
    private Paint getDefaultInnerRimBorderDarkPaint() {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(Color.argb(255, 81, 84, 89));
        paint.setStrokeWidth(0.005f);
        return paint;
    }
    ...
    public Paint getDefaultFaceShadowPaint() {
        ...
        paint.setShader(new RadialGradient(0.5f, 0.5f, mFaceRect.width() / 2.0f,
                new int[]{Color.argb(255, 40, 96, 170), Color.argb(255, 15, 34, 98), Color.argb(255, 0, 0, 0), Color.argb(255, 0, 0, 0)},
    ...
    public void setDefaultScaleRangePaints() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            mRangePaints[i].setStrokeWidth(0.01f);
            //LOVIG90 SERVE AD INGRANDIRE I NUMERI
            mRangePaints[i].setTextSize(mTextNumberSize);
    ...
    protected void onSizeChanged( final int w,  final int h, final int oldw, final int oldh) {
        ...
        Log.d(LOG_TAG,"onSizeChanged ["+getId()+"]:"+w+","+h+","+oldw+","+oldh);
        drawGauge();
    }

    private void drawGauge() {
        Log.d(LOG_TAG,"drawGauge");
        if (null != mBackground) {
        ...
        canvas.translate((scale == getWidth()) ? ((getWidth() - scale) / 2) / scale : 0
    ...
    private void drawText(final Canvas canvas) {
        Log.d(LOG_TAG,"drawText");
        final String textValue = !TextUtils.isEmpty(mTextValue) ? mTextValue : "";
        Log.d(LOG_TAG,"drawText textValue:"+textValue);
        ...
        final float startY = CENTER +0.18f;
    ...
    private void drawScale(final Canvas canvas) {
        ...
        for (int i = 0; i < totalTicks; i++) {
            ...
            // Modified by Raffmont
            final float value = getValueForTick(i)+mScaleStartValue;
            ...
            if ((Math.abs(mod - 0) < 0.001) || (Math.abs(mod - div) < 0.001)) {
                ...
                //MODIFY BY LOVIG90 SETTA IL COLORE DEI NUMERI
                if(mTextNumberColor!=-3)
                    paint.setColor(mTextNumberColor);
                ...
                drawText(canvas, valueString(Math.abs(value)), 0.5f, y3 + 0.05f, paint);

                Log.d("TEXT:",valueString(value));
            } else {
                // Draw a subdivision tick
                paint.setStrokeWidth(0.002f);
                //SETTA IL COLORE DEI DIVISION
                if(mSubDivisionsColor!=-3)
                    paint.setColor(mSubDivisionsColor);
    ...
    private void drawNeedle(final Canvas canvas) {
        if (mNeedleInitialized) {
            // Modified by Raffmont
            final float angle = getAngleForValue(mCurrentValue-mScaleStartValue);
    ...
    private void setNeedleShadowPosition(final float angle) {
        if (angle > 180 && angle < 360) {
            ...
            mNeedleLeftPaint.setShadowLayer(0.01f, -0.005f, 0.005f, Color.argb(255, 0, 0, 0));
        } else {
            // Move shadow from left to right
            mNeedleLeftPaint.setShadowLayer(0, 0, 0, Color.BLACK);
            mNeedleRightPaint.setShadowLayer(0.01f, 0.005f, -0.005f, Color.argb(255, 0, 0, 0));
        }
    }
