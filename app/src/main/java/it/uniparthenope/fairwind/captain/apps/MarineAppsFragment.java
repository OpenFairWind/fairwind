 ...
 */
public class MarineAppsFragment extends BaseAppsFragment {



    public MarineAppsFragment() {
        // Required empty public constructor
    }

    @Override
    public AppDetails getAppDetails() {
        return FairWindApplication.getFairWindModel().getAppDetails(getActivity(),AppDetails.MARINE);
    }
        ...
        if(getUserVisibleHint()) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.remove_item:
                    Set<String> set=sp.getStringSet("marine_apps", new HashSet<String>());
                    set.remove(appDetails.get(position).getPackageName().toString());
                    sp.edit().putStringSet("marine_apps",set).apply();
