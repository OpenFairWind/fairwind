 ...
 */
public class EnvironmentFragment extends FairWindFragment {
    private static final String LOG_TAG = "ENVIRONMENT_FRAGMENT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView=inflater.inflate(R.layout.fragment_boat_environment, container, false);
