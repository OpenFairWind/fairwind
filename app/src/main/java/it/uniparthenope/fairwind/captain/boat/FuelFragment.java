...
import it.uniparthenope.fairwind.sdk.ui.TankView;
 ...
 */
public class FuelFragment extends FairWindFragment {
    private static final String LOG_TAG = "FUEL_FRAGMENT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_boat_fuel, container, false);

        FairWindModelImpl fairWindModel= FairWindApplication.getFairWindModel();

        LinearLayoutCompat llcFuels= (LinearLayoutCompat) mView.findViewById(R.id.llc_fuels);
        Resources r = getResources();
        int nFuels=1;//fairWindModel.getNumberOfFuels();
        for (int nFuel=0;nFuel<nFuels;nFuel++) {
            TankView tankView =new TankView(getContext());
            tankView.setVisibility(View.VISIBLE);
            llcFuels.addView(tankView);
